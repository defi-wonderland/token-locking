...
use token_vesting::instruction::{init, unlock, initialize_unlock, change_destination, create};
...
async fn test_token_vesting() {
    ...
    let schedule = Schedule {amount: 100, release_time: 1};
...
async fn test_token_unlocking() {
    ...
    let schedule = Schedule {amount: 100, release_time: 0};
